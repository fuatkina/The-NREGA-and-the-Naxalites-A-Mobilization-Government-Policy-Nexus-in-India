...
sum Persondays_NREGA_overpop Exp_NREGA_overpop log_Naxal Naxal_dummy lit_ratio rural_ratio st_pop_ratio sc_pop_ratio total_light_cal_ worker_ratio waterdeficit_milimeters forest_ratio cropped_ratio landgini_imp log_ruralviolentprotest if year > 2005 & year < 2015
...
xtlogit Naxal_dummy L.Naxal_splag L.Naxal L.waterdeficit_milimeters L.landgini_imp L.rural_ratio L.lit_ratio L.st_pop_ratio L.sc_pop_ratio L.cropped_ratio L.forest_ratio L.total_light_cal_ i.year if year > 2006 & year < 2015, fe


logit Naxal_dummy L.Naxal_splag L.Naxal L.waterdeficit_milimeters L.landgini_imp L.rural_ratio L.lit_ratio L.st_pop_ratio L.sc_pop_ratio L.cropped_ratio L.forest_ratio L.total_light_cal_ i.year i.distname if year > 2006 & year < 2015, cluster(distname)
outreg2 using table3.xls, append excel dec(3)
logit Naxal_dummy L.Naxal_splag L.Naxal L.Persondays_NREGA_overpop L.waterdeficit_milimeters L.landgini_imp L.rural_ratio L.lit_ratio L.st_pop_ratio L.sc_pop_ratio L.cropped_ratio L.forest_ratio L.total_light_cal_ i.year i.statecode, cluster(distname)
outreg2 using table3.xls, append excel dec(3)
logit Naxal_dummy L.Naxal_splag L.Naxal L.Persondays_overpop_splag L.waterdeficit_milimeters L.landgini_imp L.rural_ratio L.lit_ratio L.st_pop_ratio L.sc_pop_ratio L.cropped_ratio L.forest_ratio L.total_light_cal_ i.year i.statecode, cluster(distname)
outreg2 using table3.xls, append excel dec(3)
logit Naxal_dummy L.Naxal L.Naxal_splag L.Exp_NREGA_overpop L.waterdeficit_milimeters L.landgini_imp L.rural_ratio L.lit_ratio L.st_pop_ratio L.sc_pop_ratio L.cropped_ratio L.forest_ratio L.total_light_cal_ i.year i.statecode, cluster(distname)
outreg2 using table3.xls, append excel dec(3)
logit Naxal_dummy L.Naxal L.Naxal_splag L.Exp_NREGA_overpop_splag L.waterdeficit_milimeters L.landgini_imp L.rural_ratio L.lit_ratio L.st_pop_ratio L.sc_pop_ratio L.cropped_ratio L.forest_ratio L.total_light_cal_ i.year i.statecode, cluster(distname)
outreg2 using table3.xls, append excel dec(3)
